...
def main():
    ...
    print(f'Intel® extension for Scikit-learn train time: {train_patched:.2f} s')

    inertia_opt = model.inertia_
    n_iter_opt = model.n_iter_
    print(f'Intel® extension for Scikit-learn inertia: {inertia_opt:.2f}')
    ...
    print(f'Intel® extension for Scikit-learn predict time: {test_time:.2f}')

    davies_bouldin_value = davies_bouldin_score(x_test, predicted_labels)
    print(f'Intel® extension for Scikit-learn Davies-Bouldin metric on test data: {davies_bouldin_value:.2f}')
